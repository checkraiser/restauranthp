...
(function() {
  ...
  DoanhThuActions = (function() {
    function DoanhThuActions() {
      this.generateActions('reloadData', 'initData', 'submitDoanhThu');
    }

    return DoanhThuActions;
...
(function() {
  ...
  DoanhThuStore = (function() {
    DoanhThuStore.displayName = 'DoanhThuStore';

    function DoanhThuStore() {
      this.bindActions(DoanhThuActions);
      this.doanh_thus = [];
      this.options_masoban = [];
      this.options_khoanmucthu = [];
      this.options_donvitinh = [];
      this.exportPublicMethods({
        getDoanhThus: this.getDoanhThus
      });
    }

    DoanhThuStore.prototype.onInitData = function(props) {
      this.doanh_thus = props.doanh_thus;
      this.options_masoban = props.options_masoban;
      this.options_khoanmucthu = props.options_khoanmucthu;
      return this.options_donvitinh = props.options_donvitinh;
    };

    DoanhThuStore.prototype.onReloadData = function() {
      return $.ajax({
        type: 'GET',
        url: '/doanh_thus',
        dataType: 'json',
        success: (function(_this) {
          return function(response) {
            _this.doanh_thus = response.doanh_thus;
            _this.options_masoban = response.options_masoban;
            _this.options_khoanmucthu = response.options_khoanmucthu;
            _this.options_donvitinh = response.options_donvitinh;
            return _this.emitChange();
          };
        })(this),
    ...
    DoanhThuStore.prototype.onSubmitDoanhThu = function(data) {
      $.ajax({
        type: 'POST',
        url: '/doanh_thus',
        dataType: 'json',
        ...
        success: (function(_this) {
          return function(response) {
            _this.doanh_thus.push(response);
            return _this.emitChange();
          };
        })(this),
        error: (function(_this) {
    ...
    DoanhThuStore.prototype.getDoanhThus = function() {
      return this.getState().doanh_thus;
    };

    return DoanhThuStore;
...
(function() {
  ...
  ChiPhiList = React.createFactory(React.createClass({
    render: function() {
      return table({}, thead({}, tr({}, th({}, 'STT'), th({}, 'Khoản mục chi'), th({}, 'Đơn vị tính'), th({}, 'Số lượng'), th({}, 'Đơn giá'))), tbody({}, _.map(this.props.chi_phis, (function(_this) {
...
(function() {
  var DoanhThuForm, DoanhThuList, a, button, div, form, h1, i, input, label, li, ref, span, table, tbody, td, th, thead, tr, ul;
  ...
  DoanhThuForm = React.createFactory(React.createClass({
    ...
    componentDidMount: function() {
      this.setTypeAheadMaSoBan();
      this.setTypeAheadKhoanMucThu();
      return this.setTypeAheadDonViTinh();
    },
    setTypeAheadMaSoBan: function() {
      return $.typeahead({
        input: "#masoban",
        minLength: 0,
        maxItem: 15,
        ...
        source: {
          data: this.props.options_masoban
        },
        debug: true,
        callback: {
          onInit: function(node) {
    ...
    setTypeAheadKhoanMucThu: function() {
      return $.typeahead({
        input: "#khoanmucthu",
        minLength: 0,
        maxItem: 15,
        ...
        source: {
          data: this.props.options_khoanmucthu
        },
        debug: true,
        callback: {
          onInit: function(node) {
    ...
    onChangeMaSoBan: function(e) {
      return this.setState({
        masoban: e.target.value
      });
    },
    onChangeKhoanMucThu: function(e) {
      return this.setState({
        khoanmucthu: e.target.value
      });
    },
    onChangeDonViTinh: function(e) {
      return this.setState({
    ...
    render: function() {
      return div({
        ...
        type: 'text',
        ref: 'masoban',
        onChange: this.onChangeMaSoBan,
        placeholder: 'Mã số bàn',
        value: this.state.masoban,
        type: 'search',
        name: 'masoban',
        autoComplete: 'off'
      }))))), div({
        ...
        type: 'text',
        ref: 'khoanmucthu',
        onChange: this.onChangeKhoanMucThu,
        placeholder: 'Khoản mục thu',
        value: this.state.khoanmucthu,
        type: 'search',
        name: 'khoanmucthu',
        autoComplete: 'off'
      }))))), div({
  ...
  DoanhThuList = React.createFactory(React.createClass({
    render: function() {
      return table({}, thead({}, tr({}, th({}, 'STT'), th({}, 'Mã số bàn'), th({}, 'Khoản mục thu'), th({}, 'Đơn vị tính'), th({}, 'Số lượng'), th({}, 'Đơn giá'))), tbody({}, _.map(this.props.doanh_thus, (function(_this) {
        return function(doanh_thu) {
          return tr({
            key: doanh_thu.id
          }, td({}, doanh_thu.id), td({}, doanh_thu.masoban), td({}, doanh_thu.khoanmucthu), td({}, doanh_thu.donvitinh), td({}, doanh_thu.soluong), td({}, doanh_thu.dongia));
        };
      })(this))));
    }
  }));
  ...
  window.DoanhThuIndex = React.createClass({
    ...
    componentWillMount: function() {
      DoanhThuStore.listen(this.onChange);
      return DoanhThuActions.initData(this.props);
    },
    componentWillUnmount: function() {
      return DoanhThuStore.unlisten(this.onChange);
    },
    onChange: function(state) {
      return this.setState(state);
    },
    render: function() {
      return div({
        ...
        className: 'column'
      }, h1({}, 'Doanh Thu'))), DoanhThuForm({
        options_masoban: this.state.options_masoban,
        options_khoanmucthu: this.state.options_khoanmucthu,
        options_donvitinh: this.state.options_donvitinh
      }), div({
        className: 'row'
      }, DoanhThuList({
        doanh_thus: this.state.doanh_thus
      })));
    }
  });
...
(function() {
  var NhapForm, NhapList, a, button, div, form, h1, i, input, label, li, ref, span, table, tbody, td, th, thead, tr, ul;
  ...
  NhapList = React.createFactory(React.createClass({
    render: function() {
      return table({}, thead({}, tr({}, th({}, 'STT'), th({}, 'Khoản mục nhập'), th({}, 'Đơn vị tính'), th({}, 'Số lượng'), th({}, 'Đơn giá'))), tbody({}, _.map(this.props.nhaps, (function(_this) {
        return function(nhap) {
          return tr({
            key: nhap.id
          }, td({}, nhap.id), td({}, nhap.tenhang), td({}, nhap.donvitinh), td({}, nhap.soluong), td({}, nhap.dongia));
        };
      })(this))));
    }
  }));
  ...
  window.NhapIndex = React.createClass({
    ...
    componentWillMount: function() {
      ...
      return NhapActions.initData(this.props);
    },
    componentWillUnmount: function() {
